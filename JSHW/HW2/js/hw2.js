...
//
//Циклы в программировании нужны для того, что бы уменьшить рутинную работу кодера по копипасту одних и тех же строк кода, и выполнить их заданное
// количество раз, или выполнять один и тот же код, до соблюдения заданных условий.

let border = +prompt('Enter number below: ');

while (Number.isInteger(border)==false){
    border = +prompt('Enter number below: ');
}

for(let i=0; i<=border; i+=5){
    if(border<5){
